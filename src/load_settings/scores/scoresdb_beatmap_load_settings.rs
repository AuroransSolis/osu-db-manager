    ...
    pub fn set_from_query(&mut self, args: Vec<&str>) -> IoResult<()> {
        let matches = App::new("scores.db beatmap query parser")
            .arg(Arg::with_name("MD5 beatmap hash")
                ...
                .number_of_values(1)
                .value_name("HASH"))
            .arg(Arg::with_name("Number of scores")
            ...
            .subcommand(SubCommand::with_name("SCORE-QUERY")
                .arg(Arg::with_name("Gameplay mode")
                    ...
                    .number_of_values(1)
                    .value_name("MODE"))
                .arg(Arg::with_name("Score version")
                    .long("SCORE-VERSION")
                    .required(false)
                    .multiple(false)
                    .takes_value(true)
                ...
                .arg(Arg::with_name("Player name")
                    ...
                    .number_of_values(1)
                    .value_name("NAME"))
                .arg(Arg::with_name("MD5 replay hash")
                    ...
                    .number_of_values(1)
                    .value_name("HASH"))
                .arg(Arg::with_name("Number of 300s")
                    .long("NUMBER-OF-300S")
                    .required(false)
                    .multiple(false)
                    .takes_value(true)
                    .number_of_values(1)
                    .value_name("NUMBER/RANGE"))
                .arg(Arg::with_name("Number of 100s (standard/CTB)/150s (taiko)/200s (mania)")
                    .long("NUMBER-OF-100S")
                    .required(false)
                    .multiple(false)
                    .takes_value(true)
                    .number_of_values(1)
                    .value_name("NUMBER/RANGE"))
                .arg(Arg::with_name("Number of 50s (standard/mania)/small fruit (CTB)")
                    .long("NUMBER-OF-50S")
                    .required(false)
                    .multiple(false)
                    .takes_value(true)
                    .number_of_values(1)
                    .value_name("NUMBER/RANGE"))
                .arg(Arg::with_name("Number of gekis/max 300s (mania)")
                    ...
                    .number_of_values(1)
                    .value_name("NUMBER/RANGE"))
                .arg(Arg::with_name("Number of katus/100s (mania)")
                    ...
                    .number_of_values(1)
                    .value_name("NUMBER/RANGE"))
                .arg(Arg::with_name("Number of misses")
                    ...
                    .number_of_values(1)
                    .value_name("NUMBER/RANGE"))
                .arg(Arg::with_name("Replay score")
                    .long("REPLAY-SCORE")
                    .required(false)
                    .multiple(false)
                    .takes_value(true)
                ...
                .arg(Arg::with_name("Max combo")
                    ...
                    .number_of_values(1)
                    .value_name("NUMBER/RANGE"))
                .arg(Arg::with_name("Perfect combo")
                    .long("PERFECT-COMBO")
                    .required(false)
                    .multiple(false)
                    .takes_value(true)
                ...
                .arg(Arg::with_name("Mods used")
                    ...
                    .number_of_values(1)
                    .value_name("MODS"))
                .arg(Arg::with_name("Replay timestamp")
                ...
                .arg(Arg::with_name("Online score ID")
