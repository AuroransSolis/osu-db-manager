...
impl BeatmapQuery {
    pub fn from_arg(s: &str) -> IoResult<Self> {
        ...
        get_matches_and_assign!(matches {
            ...
            "Artist name", artist_name => String;
            "Artist name unicode", artist_name_unicode => String;
            "Song title", song_title => String;
            "Song title unicode", song_title_unicode => String;
            "Creator name", creator_name => String;
            "Difficulty", difficulty => String;
            "Audio file name", audio_file_name => String;
            "MD5 beatmap hash", md5_beatmap_hash => String;
            ".osu file name", dotosu_file_name => String;
            ...
            "Last modification time", last_modification_time => SystemTime;
            ...
            "Beatmap folder name", beatmap_folder_name => String;
            "Last checked against repo", last_checked_against_repo => SystemTime;
